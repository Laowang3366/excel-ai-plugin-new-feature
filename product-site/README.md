...
npm run publish-release -- \
  --version 0.1.79 \
  --installer ../desktop/release/Wengge-AI-Assistant-Setup-0.1.79.exe \
  --blockmap ../desktop/release/Wengge-AI-Assistant-Setup-0.1.79.exe.blockmap \
  --latest-yml ../desktop/release/latest.yml \
  --notes-file ../release-notes/0.1.79.json \
...
```bash
cd ../desktop
npm run patch:build -- --id patch-001 --base-version 0.1.79 --output release/patch-001.zip
```
