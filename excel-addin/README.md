...
| `sheet.pageLayout.get/set` | Office.js：**ExcelApi 1.9** `pageLayout` 子集（orientation/margins/print flags/zoomScale/paperSize a3\|a4\|a5\|letter\|legal/fitToPagesWide\|Tall 1..32767/printArea/titles）；fit 与 zoomScale 互斥；print* 仅非空设置。**无** clear/headers/footers/page breaks/draft/pageOrder/firstPageNumber/fitToOnePage。WPS → unsupported |
