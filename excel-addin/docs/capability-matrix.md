...
| chart advanced | formula/categoryFormula/export/complex layout | unsupported | unsupported | formatChart | Phase47 trendlines + Phase48 series markers; formula/categoryFormula still no Office.js contract; stacked/3D/stock/funnel not claimed; showPercentage/showBubbleSize/delete/position/format/leaderLines not claimed |
