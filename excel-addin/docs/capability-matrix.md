...
- Phase55/55.1: `workbook.template.apply` (ExcelApi 1.8 desktop applyWorkbookTemplate parity; plan/readback + pre-write surface) + `workbook.template.capture` (ExcelApi 1.9 single Excel.run shallow capture/inspect); WPS unsupported; **not** real Excel/WPS sideload verified.
