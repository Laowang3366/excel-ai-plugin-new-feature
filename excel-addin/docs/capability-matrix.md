...
- Phase55: `workbook.template.apply` (ExcelApi 1.8 desktop applyWorkbookTemplate parity) + `workbook.template.capture` (ExcelApi 1.9 shallow capture/inspect; one tool); WPS unsupported; **not** real Excel/WPS sideload verified.
