...
export function buildAddInHardBoundary(): string {
  return [
    ...
    "- 作用域：仅当前活动 Excel/WPS 工作簿；不得声称可打开/创建/保存/切换任意磁盘路径上的其他工作簿。",
