...
import { officeJsTemplateMethods } from "./officeJsTemplateFacade";
import {
  getExcelRun,
...
import {
  officeJsAddChartSeriesTrendline,
  officeJsDeleteChartSeriesTrendline,
  officeJsListChartSeriesTrendlines,
...
export class OfficeJsAdapter implements HostAdapter {
  ...
  listChartSeriesTrendlines = officeJsListChartSeriesTrendlines;
  ...
  applyWorkbookTemplate = officeJsTemplateMethods.applyWorkbookTemplate;
  captureWorkbookTemplate = officeJsTemplateMethods.captureWorkbookTemplate;
}
