...
import type { CompactionReason, ThreadCompactStartParams } from "./compactionTypes";
import type { ToolRiskLevel } from "../tools/contracts/toolExecutor";
...
export type {
  ...
  ToolExecutor,
} from "../tools/contracts/toolExecutor";
