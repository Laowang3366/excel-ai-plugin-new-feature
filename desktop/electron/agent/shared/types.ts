...
export type AgentEvent =
  ...
  | ({ type: "tool_approval_required"; toolCallId: string; toolName: string; arguments: Record<string, unknown>; riskLevel: ToolRiskLevel; description?: string; canAlwaysAllow?: boolean } & AgentEventThreadContext)
