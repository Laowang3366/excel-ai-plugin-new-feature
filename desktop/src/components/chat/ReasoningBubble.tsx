 ...
 */
export const ReasoningBubble: React.FC<ReasoningBubbleProps> = React.memo(({ item, elapsedDuration, defaultExpanded = false }) => {
  ...
  return (
    <div className="reasoning-bubble">
      ...
      >
        ...
        {elapsedDuration && (
          <span className="reasoning-duration">{elapsedDuration}</span>
        )}
