...
export const MODEL_TEXT = {
  "zh-CN": {
    ...
    reasoningOptions: "推理等级选项",
    reasoningOptionsHint: "选择该模型支持的推理等级范围，不同 API 部署可能支持不同等级",
  ...
  "en-US": {
    ...
    reasoningOptions: "Reasoning level options",
    reasoningOptionsHint: "Select the reasoning level set supported by this model. Different API deployments may support different levels.",
